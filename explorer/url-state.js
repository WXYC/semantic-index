...
export const DEFAULTS = { edge: "djTransition", depth: "2", limit: "10", month: "", dj: "" };

/**
 * Parse URL search string into graph state.
 * @param {string} search - URL search string (e.g. "?artist=Autechre&edge=sharedStyle")
 * @returns {{ artist: string|null, edge: string, depth: string, limit: string, month: string, dj: string }}
 */
 ...
 * @param {{ edge: string, depth: string, limit: string, month: string, dj: string }} controls
